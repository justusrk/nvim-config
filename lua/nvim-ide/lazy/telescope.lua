return {
    {
        ...
        config = function()
            ...
            vim.keymap.set("n", "<leader>fgb", builtin.git_branches, {}) -- find git branches
            vim.keymap.set("n", "<leader>fgc", builtin.git_commits, {}) -- find git branches
            vim.keymap.set("n", "<leader>fgcb", builtin.git_bcommits, {}) -- find git branches
            vim.keymap.set("n", "<leader>fgs", builtin.git_status, {}) -- find git branches
            ...
            require('telescope').load_extension('smart_history') -- need to install sqlite through `brew install sqlite`
        end
    }
}
